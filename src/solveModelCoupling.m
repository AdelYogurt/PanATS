function [Cl,Cd,LDratio,Cmz,max_heat_flow]=solveModelCoupling(rou_1,V_1,FREESTREAM_TEMPERATURE,FREESTREAM_PRESSURE,MACH_NUMBER,GAMMA_VALUE,AOA,SIDESLIP_ANGLE,...
...
while ~done
    ...
    [~,~,~,~]=solveModelHypersonicInviscid...
        ([],[],FREESTREAM_TEMPERATURE,FREESTREAM_PRESSURE,MACH_NUMBER,GAMMA_VALUE,AOA,SIDESLIP_ANGLE,...
        ref_point,REF_LENGTH,REF_AREA,REYNOLDS_NUMBER);
