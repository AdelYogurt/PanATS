...
fig_hdl=figure();
line(X_blunt_cone_exp,Q_blunt_cone_exp,'Marker','s','Color','r','LineStyle','none','MarkerFaceColor','r');
line(X_blunt_cone_SU2/568.7e-3,Q_blunt_cone_SU2/Q_0,'Color','b','LineWidth',1);
line(X_blunt_cone_HATS/568.7e-3,Q_blunt_cone_HATS/Q_0,'Color',[0.9290 0.6940 0.1250],'LineWidth',1);
set(gca,'Xlim',[-0.1,1]);
