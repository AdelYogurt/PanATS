...
normal_vector_len=vecnorm(point_normal_vector_list,2,2);normal_vector_len(normal_vector_len == 0)=1;
point_normal_vector_list=point_normal_vector_list./normal_vector_len;
